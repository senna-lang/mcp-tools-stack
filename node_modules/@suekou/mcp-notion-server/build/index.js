...
const retrieveBlockChildrenTool = {
...
const updatePagePropertiesTool = {
...
const createCommentTool = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            discussion_id: {
                type: "string",
                description: "The ID of an existing discussion thread to add a comment to." + commonIdDescription,
            },
            rich_text: {
                type: "array",
...
const retrieveCommentsTool = {
    ...
    inputSchema: {
        ...
        properties: {
            block_id: {
                type: "string",
                description: "The ID of the block or page whose comments you want to retrieve." + commonIdDescription,
            },
            start_cursor: {
                type: "string",
        ...
        try {
            ...
            switch (request.params.name) {
                case "notion_append_block_children": {
                    ...
                    const response = await notionClient.appendBlockChildren(args.block_id, args.children);
                    return {
                ...
                case "notion_retrieve_block_children": {
                    ...
                    const response = await notionClient.retrieveBlockChildren(args.block_id, args.start_cursor, args.page_size);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                ...
                case "notion_update_page_properties": {
                    ...
                    const response = await notionClient.updatePageProperties(args.page_id, args.properties);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_list_all_users": {
                    const args = request.params
                        .arguments;
                    const response = await notionClient.listAllUsers(args.start_cursor, args.page_size);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                ...
                case "notion_query_database": {
                    ...
                    const response = await notionClient.queryDatabase(args.database_id, args.filter, args.sorts, args.start_cursor, args.page_size);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_create_database": {
                    const args = request.params
                        .arguments;
                    const response = await notionClient.createDatabase(args.parent, args.title, args.properties);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                ...
                case "notion_update_database": {
                    const args = request.params
                        .arguments;
                    const response = await notionClient.updateDatabase(args.database_id, args.title, args.description, args.properties);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_create_database_item": {
                    const args = request.params
                        .arguments;
                    const response = await notionClient.createDatabaseItem(args.database_id, args.properties);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_create_comment": {
                    ...
                    const response = await notionClient.createComment(args.parent, args.discussion_id, args.rich_text);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_retrieve_comments": {
                    ...
                    const response = await notionClient.retrieveComments(args.block_id, args.start_cursor, args.page_size);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
                case "notion_search": {
                    const args = request.params.arguments;
                    const response = await notionClient.search(args.query, args.filter, args.sort, args.start_cursor, args.page_size);
                    return {
                        content: [{ type: "text", text: JSON.stringify(response) }],
                    };
                }
